...
export default function HotProducts({ products, brands }: HotProductsProps) {
  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-center">Hot Products</h2>
            ...
            return (
              <Card key={product.id} className="overflow-hidden">
                ...
                <CardFooter className="p-4 pt-0 flex justify-between">
                  ...
                  <Button className="w-[48%]">Add to Cart</Button>
                </CardFooter>
              </Card>
            )
          })}
